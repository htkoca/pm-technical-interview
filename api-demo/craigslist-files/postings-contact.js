  ...
  setupPositionProbePattern: function(a, b) {
      for (var c = -1; c <= 7; c++)
          if (!(a + c <= -1 || this.moduleCount <= a + c))
              for (var d = -1; d <= 7; d++) b + d <= -1 || this.moduleCount <= b + d || (this.modules[a + c][b + d] = 0 <= c && c <= 6 && (0 == d || 6 == d) || 0 <= d && d <= 6 && (0 == c || 6 == c) || 2 <= c && c <= 4 && 2 <= d && d <= 4)
  },
      ...
      for (var a = QRUtil.getPatternPosition(this.typeNumber), b = 0; b < a.length; b++)
          for (var c = 0; c < a.length; c++) {
              ...
              if (null == this.modules[d][e])
                  for (var f = -2; f <= 2; f++)
                      for (var g = -2; g <= 2; g++) this.modules[d + f][e + g] = f == -2 || 2 == f || g == -2 || 2 == g || 0 == f && 0 == g
          }
  },
...
QRPolynomial.prototype = {
      ...
      for (var d = c.length / 3, e = new Array, f = 0; f < d; f++)
          for (var g = c[3 * f + 0], h = c[3 * f + 1], i = c[3 * f + 2], j = 0; j < g; j++) e.push(new QRRSBlock(h, i));
      return e
          ...
          if (b && c) {
              ...
              var e = new L.LatLng(b, c),
                  f = new L.TileLayer(CL.maps.clMapsUrl, {
                      ...
                      prefix: "",
                      attribution: '&copy; craigslist - Map data &copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a>'
                  }),
                  g = 14;
              d > 19 && (g = 13);
              var h = new L.Map("map", {
              ...
              if (CL.maps.map = h, h.attributionControl.setPrefix(""), d > 19 ? L.circle(e, 1500, {
                      color: "#770091",
                      weight: 1,
                      fillOpacity: .1
                  }).addTo(h) : L.marker(e, {
                      draggable: !1
                  }).addTo(h), CL.page.isMobile && $("body.post").length) h.dragging.disable(), h.touchZoom.disable(), h.doubleClickZoom.disable(), h.scrollWheelZoom.disable(), h.boxZoom.disable(), h.keyboard.disable(), a.prepend('<div class="mapglass"></div>').find(".mapglass").on("touchstart touchmove", function(a) {
      ...
      if (0 !== $("body.posting, body.post, body.best").length) {
          ...
          if (CL.browser.canvas) {
              ...
              c.qrcode({
                  width: 200,
                  height: 200,
                  text: c.data("location")
              })
          }
          var d = function() {
                  var a = $(".reply-email-address").text(),
                      b = $(".reply-tel-number").text();
                  a.length > 0 && $(".print-email").text(a), b.length > 0 && $(".print-phone").text(b)
              },
              e = function() {
                  ...
                  var c = $("#thumbs img.selected").parent().index(),
                      e = [],
                      f = window.imgList || [];
                  ...
                  }), 0 === $(".print-pics").children().length && $(".print-pics").append(e)
              };
          ...
          window.onbeforeprint = e, $("#printme").on("click", function(a) {
              ...
              if (c) {
                  var e = c.curSearch();
                  CL.banish.isBanished(window.pID) ? $(".postingtitle").addClass("banished") : $(".postingtitle").removeClass("banished"), $(".unbanish").on("click", function() {
                      CL.banish.unban(d), b.text(CL.banish.banishedCount()), $(".postingtitle").removeClass("banished"), a.removeClass("is-banished");
                      var c = "/flag/?async=async&flagCode=36&postingID=" + d;
                      $.get(c)
                  }), $(".banish").on("click", function() {
                      CL.banish.ban(d), b.text(CL.banish.banishedCount()), $(".postingtitle").addClass("banished"), a.addClass("is-banished");
                  ...
                  if (c.hasPosting(d)) {
                      ...
                      $(".backup").attr("href", g), $(".next").on("click", function() {
                          c.setSearch(e)
          ...
          var h = $(".flaglink"),
              i = $(".bestof-link");
          CL.page.isMobile && $(".mapbox").insertAfter("#postingbody"), window.pID && (h.on("click", function(c) {
              c.preventDefault();
              var d = window.pID;
              $(".flags").addClass("done"), h.contents().unwrap(), $.get("/flag/?async=async&flagCode=" + $(this).data("flag") + "&postingID=" + d).done(function(a) {
                  h.find(".flagtext").text(a)
              }), CL.browser.localStorage && (CL.banish.ban(d), b.text(CL.banish.banishedCount()), $(".postingtitle").addClass("banished"), a.addClass("is-banished"))
          }), i.on("click", function(a) {
              a.preventDefault(), i.hasClass("disabled") || (i.contents().unwrap(), $(".bestof-icon").addClass("done"), $.get("/flag/?async=async&flagCode=" + $(this).data("flag") + "&postingID=" + window.pID))
          }));
          var j = $("time"),
          ...
          j.on("click", function() {
              j.each(function() {
                  var a = $(this),
                      b = a.text();
                  a.text(a.attr("title")).attr("title", b).toggleClass("abs")
              })
          }), k.each(function() {
              $(this).css("opacity", 1)
          });
          ...
          if (!window.bestOf) {
              ...
              var q, r, s, t, u, v = !1,
                  ...
                  z = function() {
                      ...
                      if (a) {
                          var b, c = document;
                          if (c.body.createTextRange) b = c.body.createTextRange(), b.moveToElementText(a), b.select();
                          else if (window.getSelection) {
                              var d = window.getSelection();
                              b = c.createRange(), b.selectNodeContents(a), d.removeAllRanges(), d.addRange(b)
                          }
                      }
                  },
                  A = function(a) {
                      ...
                      b.length > 0 ? q.html(b.html()) : (b = p.find(".js-captcha"), b.length > 0 ? q.html(b) : q.html(a)), q.not(":visible") && (q.show(), x = !0), p.html(""), y.close(), w = !0, z()
                  },
                  B = function(a) {
                      var b = $.parseHTML(a),
                          c = $('input[name="n"]', b);
                      c && (s = c.attr("value")), c = $('input[name="site_key"]', b), c && (t = c.attr("value")), (c = $('input[name="error"]', b)) && (u = c.attr("value"))
                  };
              CL.page.gRecaptchaVerifyCallback = function(a) {
                  ...
                  window.grecaptcha.render("g-recaptcha", {
                      ...
                      size: "invisible"
                  }), y.scrollWithDocument().center(), window.grecaptcha.execute()
              };
              var C = function(b) {
                      if (b.indexOf("standalone_captcha") >= 0) return y('<div id="g-recaptcha" class="captcha_form"></div>', {
                          position: "absolute"
                      }), B(b), a.prepend('<script src="https://www.google.com/recaptcha/api.js?onload=gRecaptchaCallback&render=explicit" async defer></script>'), void(v = !0);
                      A(b)
                  },
                  D = !1,
                  E = function(a, b, c) {
                      if (!D) {
                          q = c, r = b;
                          var d = b.split("/", 2)[1];
                          if (v) return w && (window.grecaptcha.reset(), w = !1, window.grecaptcha.execute({
                              action: d
                          })), void y(null, {
                              keepContent: !0
                          });
                          D = !0, $.get(r, function(a) {
                              D = !1, C(a)
                          }).fail(function() {
              ...
              m.length && (l.hide(), m.on("click", function(a) {
                  return a.stopPropagation(), l.html().length > 0 ? (x = !x, void l.toggle()) : E(0, $("#replylink").attr("href"), l)
              }), a.click(function(a) {
                  x && !$(a.target).closest(l).length && (l.hide(), x = !1)
              })), n.length && n.on("click", function(a) {
                  return a.preventDefault(), E(0, $(".showcontact").attr("href"), o)
              })
          }! function() {
              var a = new Date;
              a.setHours(0), a.setMinutes(0), a.setSeconds(0), a.setMilliseconds(0), $(".property_date").each(function() {
                  var b = $(this),
                      c = b.data("date").toString().split("-");
                  new Date(c[0], c[1] - 1, c[2]) <= a && b.addClass("attr_is_today").text(b.data("today_msg"))
              })
          }();
          var F = $(".swipe"),
              G = F.find(".swipe-wrap"),
              H = G.find(".slide"),
              I = {};
          Array.isArray(window.imgList) && window.imgList.forEach(function(a) {
              I[a.shortid] = a
          });
          var J, K, L = function(a, b) {
                  var c = $("<picture></picture>");
                  return "medium" === b && $("<source>").attr({
                      srcset: [CL.image.url(a, "medium")].join(", ")
                  }).appendTo(c), $("<img>").attr({
                      src: CL.image.url(a, b)
                  }).appendTo(c), c
              },
              M = !1,
              N = 0,
              O = CL.browser.touchCapable ? 150 : -1;
          window.imgList && window.imgList[0].imgid.search(/^0:/) === -1 ? G.on("click", "img", function() {
              var a, b, c, d, e = {},
                  f = window.innerWidth,
                  g = window.innerHeight,
                  h = !CL.browser.matchMedia && screen.width < 768 || CL.browser.matchMedia && matchMedia("(max-width: 767px)").matches;
              if (CL.browser.touchCapable && h) return void(window.location.href = CL.image.url(window.imgList[N].imgid, "large"));
              if (J) K.slide(N, 0);
              else {
                  J = $(".gallery").clone().addClass("big"), 2 === window.imgList.length && J.find(".slide:gt(1)").remove(), c = Math.min(1200, f - 50), d = Math.min(900, g - 40);
                  var i = $("<div></div>").width(1200).height(900).scaleToFit({
                      width: c,
                      height: d
                  });
                  a = i.width(), b = i.height(), J.css({
                      overflow: "hidden",
                      width: a + "px",
                      height: b + "px"
                  }).find(".slide").each(function(c, d) {
                      var e = $(d).empty(),
                          f = e.data("imgid");
                      e.append(L(I[f].imgid, "large").find("img").css({
                          "max-width": a + "px",
                          "max-height": b + "px"
                      }))
                  })
              ...
              }), CL.lightbox(J, e), $(window).on("orientationchange", function() {
                  setTimeout(function() {
                      CL.lightbox.center()
                  }, 100)
              })
              ...
              R = CL.swipe.makeGallery(P, {
                  ...
                  callback: function(a) {
                      if (T(a), N = a, !Q) {
                          ...
                          H.each(function(a) {
                              0 !== a && $(this).empty().append(L((b[a] || b[a - 2]).imgid, "medium"))
                          }), Q = !0
                      }
                  }
              });
          H = $(".slide"), CL.banish.ready.done(function() {
              var c = CL.banish.banishedCount();
              $(".unfaves").attr("value", CL.banish.encode()), b.text(c), a.toggleClass("has-banished", c > 0), $(".to-banish-page-link").off("click").on("click", function(a) {
                  a.stopPropagation(), a.preventDefault(), $(".unfavform").submit()
              })
          });
          var S = $("#thumbs"),
              T = function(a) {
                  S.find(".selected").removeClass("selected"), S.find(".thumb").eq(a).find("img").addClass("selected")
              };
          S.on("touchstart touchend click mouseover", ".thumb", function(a) {
              "click" === a.type ? a.preventDefault() : "touchend" === a.type && (a.stopPropagation(), a.preventDefault());
              var b = $(this).index();
              R.slide(b), T(b)
          })
      }
  }();
/* {"sources":{"postings-concat.js":"9dfb36c66b0287788ba7684993f688b3"}} */